              ...
              children: [
                ...
                RoundedLoadingButton(
                    ...
                    onPressed: () async {
                      ...
                      var connections = FirebaseFirestore.instance
                          .collection('awaitingConnections');
                      await connections
                          .get()
                          .then((value) => value.docs.forEach((element) {
                                if (element['to'] ==
                                        usernameTextController.text &&
                                    element['from'] == user!.email) {
                      ...
                      if (!alreadySent) {
                        ...
                        if (reqUserToken != null) {
                          await connections.add({
                            'to': usernameTextController.text,
                            'from': user.email,
                            'accepted': false
                          });
                          print(reqUserToken);
                          sendNotification('You have a new Friend Request',
                              'From ${user.email}', [reqUserToken], 'msg_req');
                          final snackBar =
                    ...
                    child: requests.length == 0
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                title: Text(requests[index].email),
                                trailing: adding
                                    ? Container(
                                        width: 15,
                                        height: 15,
